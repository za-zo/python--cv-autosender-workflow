...
def build_message_prompt(profile, company, job):
    ...
    portfolio_line = f"Portfolio: {profile['portfolio']}\n" if profile.get("portfolio") else ""
    github_line = f"GitHub: {profile['github']}\n" if profile.get("github") else ""
    linkedin_line = f"LinkedIn: {profile['linkedin']}\n" if profile.get("linkedin") else ""
    ...
    user_message = (
        ...
        f"{portfolio_line}{github_line}{linkedin_line}"
